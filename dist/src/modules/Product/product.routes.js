...
sendImageToCloudinary_1.upload.array('images', 10), // Max 10 images
...
router.patch('/update-product/:id', (0, auth_1.default)('ADMIN', 'SUPER_ADMIN'), sendImageToCloudinary_1.upload.array('images', 10), parseJson_1.parseJsonFields, (0, validateRequest_1.default)(product_validation_1.ProductValidation.updateProductZodSchema), product_controller_1.ProductController.updateProduct);
...
router.get('/get-products-by-category-id/:categoryId', product_controller_1.ProductController.getProductsByCategoryId);
router.get('/get-products-by-category-name/:categoryName', product_controller_1.ProductController.getProductsByCategoryName); /* NOT WORKING */
